...
\title{Thesis Chapter: Calibration Source \& GPS}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/redundant baseline.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{Figures/Calsource system.png}
...
\begin{figure}[!htbp]
    \begin{minipage}{0.44\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/calbox picture.png}
    \end{minipage}
    \begin{minipage}{0.54\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/Picture Cal box.png}
    \end{minipage}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/tom_window 2.png}
...
\begin{figure}[!htbp]
    \begin{minipage}{0.57\linewidth}
        \centerline{\includegraphics[width=1\linewidth]{Figures/photo_caltower.jpg}}
    \end{minipage}
    \hfill
    \begin{minipage}{0.41\linewidth}
        \centerline{\includegraphics[width=1\linewidth]{Figures/anti-rotational_structure.jpg}}
    \end{minipage}
    \hfill
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/calsource_amplitude_variations_yaw.png}
...
\begin{figure}[!htbp]
    \begin{minipage}{0.39\linewidth}
        \centerline{\includegraphics[width=1\linewidth]{Figures/Antennas.jpg}}
    \end{minipage}
    \hfill
    \begin{minipage}{0.59\linewidth}
        \centerline{\includegraphics[width=1\linewidth]{Figures/Picture Cal box.png}}
    \end{minipage}
    \hfill
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/GPS data table.png}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\textwidth]{Figures/test antenna position.png}
        \caption{}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\textwidth]{Figures/plot gps data.png}
        \caption{\phantom{}} 
        \label{fig:b}
    \end{subfigure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/drawing Gps data.png}
...
\begin{figure}[ht]
    \begin{minipage}{0.49\linewidth}
        \centerline{\includegraphics[width=1\linewidth]{Figures/experiment_configuration.png}}
    \end{minipage}
    \hfill
    \begin{minipage}{0.49\linewidth}
        \centerline{\includegraphics[width=1\linewidth]{Figures/distances_during_experiment.png}}
    \end{minipage}
    \hfill
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/gps_data_w_pb.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/std_deviation.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/standard_deviation_rpN.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/standard_deviation_roll.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/ps_fit.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/power_spectrum_gps.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/noise_ps_awhite_roll.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/drawing Gps issue.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/antennas_position.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/calsource_deviation.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/Uncertainty_computations_figure.png}
...
\begin{figure}[!htbp] 
    ...
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/simulated_correlated_noise.png}
    ...
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/simulated_correlated_noise_distribution.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/difference_correlation_matrix.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\linewidth]{Figures/MC_amplitude_distrib.png}
...
\begin{thebibliography}{9}
    \bibitem{paper_selfcal_1}
    T. J. Cornwell and P. N. Wilkinson, “A new method for making maps with unstable radio interferometers,” MNRAS, vol. 196, pp. 1067–1086, Sep 1981.

    \bibitem{paper_selfcal_2}
    T. J. Pearson and A. C. S. Readhead, ``Image formation by self-calibration in radio astronomy'',  Annual review of astronomy and astrophysics. Volume 22. Palo Alto, CA, Annual Reviews, Inc., 1984, p. 97-130.

    \bibitem{selfcal_overview}
    T. Cornwell and E. B. Fomalont, “Self-Calibration,” in Synthesis Imaging in Radio Astronomy II (G. B. Taylor, C. L. Carilli, and R. A. Perley, eds.), vol. 180 of Astronomical Society of the Pacific Conference Series, p. 187, Jan 1999.

    \bibitem{thesislouise}
    L. Mousset, ``Exploring the primordial Universe, inflation and primordial gravitational waves with QUBIC, the Q and U Bolometric Interferometer for Cosmology'', PhD Thesis, 2021.

    \bibitem{thesismarie}
    M. A. Bigot-Sazy, ``Mesure des anisotropies de polarisation du fond diffus cosmologique avec l'interferomètre bolométrique QUBIC'', PhD Thesis, 2013.
 
    \bibitem{thesisromain}
    R. Charlassier, “Mesure des anisotropies de polarisation du fond diffus cosmologique avec
    l’interféromètre bolomètrique QUBIC,” Paris 7, 2010, 1 vol. (244 p.) (Cit. on pp. 13, 34, 50).

    \bibitem{paper_marie_selfcal}
    M.-A. Bigot-Sazy et al., ``Self-Calibration: an efficient method to control systematic effects in Bolometric Interferometry'', A\&A, vol. 550, p. A59, Feb 2013.

    \bibitem{qubic1}
    J.-Ch. Hamilton et al., ``QUBIC I: Overview and Science Program'', 2021.

    \bibitem{qubic3}
    S.A. Torchinsky et al., ``QUBIC III: Laboratory Characterization'', 2022.

    \bibitem{dgps_accuracy}
    C. Blesing et al., ``Accuracy evaluation of a Low-Cost Differential Global Positioning System for mobile robotics'', 2023.

    \bibitem{gps_accuracy}
    \url{https://www.gps.gov/systems/gps/performance/accuracy/}

    \bibitem{gps_frequencies}
