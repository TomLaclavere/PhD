...
# Paper information
NAME="Bolometric interferometry and spectral: a QUBIC overview"
...
JOURNAL="Proceeding Moriond 2024"

# Authors
AUTHORS="Tom Laclavère"

# Path information
PAPER_DIR="publications/moriond2024"
OUT_FILE="website/partials/publications/moriond2024.html"
...
fig_count="$(find "$PAPER_DIR/Figures" -type f | wc -l | tr -d ' ')"
