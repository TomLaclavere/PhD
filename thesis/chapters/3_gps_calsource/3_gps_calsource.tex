...
We need to perform this fit on the 41 different configurations for each five GPS data. These results are summary in the Figure~\ref{fig:power_spectrum_gps}. We will describe this figure part by part to extract all the relevant information.
