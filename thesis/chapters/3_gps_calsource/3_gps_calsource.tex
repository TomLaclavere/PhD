...
\personal{My contributions are related to the study of differential GPS. I ran tests to understand its functioning and the meaning of the output data. I also analysed the noise of this system, which will be used to choose the best configuration to install at the observation site, as presented in section~\ref{section: gps}. Then, I wrote a software adapted to our specific use that is detailed in Section~\ref{section: calsource pos & orientation}. This software can be found in the qubicsoft GitHub repository : \url{https://github.com/qubicsoft/qubic/blob/master/qubic/lib/Qgps.py}}
...
This work was done thirteen years ago, a more up-to-date analysis, taking into account the evolution of the instrumental design and of our understanding, is needed to confirm these predictions. \tom{A PhD student recently started to work on this vast topic.}
...
\end{equation}
where $d_{\text{cal}}$ is the distance between the calibration source and QUBIC. As said in the Section~\ref{cal tower}, the calibration source will be placed at 48.6 m height, the distance on the ground between the tower and QUBIC is 38.44 m while the height of QUBIC from the ground is approximatively 4 m. By simple trigonometry, we can set that $d_{\text{cal}}= 58.88$ m from these values.
