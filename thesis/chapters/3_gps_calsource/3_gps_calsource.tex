...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{tom_window 2.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{ps_fit.png}
