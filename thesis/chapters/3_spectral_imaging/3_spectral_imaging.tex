...
\begin{align}
    ...
    &= \frac{e^{i\frac{\pi N_{horns}\Delta_h}{\lambda}(\frac{x_f}{D_f} - n_x)}}{e^{i\frac{\pi\Delta_h}{\lambda}(\frac{x_f}{D_f} - n_x)}} \frac{\sin(\frac{\pi N_{horns}\Delta_h}{\lambda}[\frac{x_f}{D_f} - n_x])}{\sin(\frac{\pi\Delta_h}{\lambda}[\frac{x_f}{D_f} - n_x])} \frac{e^{i\frac{\pi N_{horns}\Delta_h}{\lambda}(\frac{y_f}{D_f} - n_y)}}{e^{i\frac{\pi\Delta_h}{\lambda}(\frac{y_f}{D_f} - n_y)}} \frac{\sin(\frac{\pi N_{horns}\Delta_h}{\lambda}[\frac{y_f}{D_f} - n_y])}{\sin(\frac{\pi\Delta_h}{\lambda}[\frac{y_f}{D_f} - n_y])}
\end{align}
