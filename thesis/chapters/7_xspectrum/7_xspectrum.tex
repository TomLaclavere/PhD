...
\caption{\jc{Triangle plot of the posterior distribution of the parameters fitted on the cross-spectra obtained with CMM. In this plot, the reference frequency for dust emission is $150$ GHz, instead of the most common $353$ GHz, ence the small value for $A_d$.}}
