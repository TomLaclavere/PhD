...
Based on this extension, \texttt{Qubic\allowbreak MultiAcquisitions} builds one \texttt{Qubic\allowbreak Acquisition} object per sub-band from \texttt{Qubic\allowbreak MultibandInstrument}. This class builds the multifrequency operator $H$.
...
Additionally, we defined the class \texttt{QubicInstrumentType}, a subclass of \texttt{QubicMultiAcquisitions}. Its purpose is to handle the various instrumental designs of QUBIC (Ultra Wide Band, Dual Bands and Mono Band), which necessitate extra care regarding the shape of the operators.
